...
#define FALSE 0
	...
	*/
	...
	/// \param[in] Value int value to set on the field.
	...
	/// \fn void setTriggerMode(OCTDeviceHandle Dev, DeviceTriggerType Trigger);
	...
	/// \ingroup ScanPattern
	/// \brief Returns the expected acquisition time of the scan pattern. Please 
	...
	/// \ingroup Data
	/// \brief Performs a minimal segmentation of the data, by finding a surface that is compromised of the highes signals fromo each A-scan.
	...
	/// \ingroup PostProcessing
	/// \brief Computes a 2D-median filter on the specified 2D data. 
	/// \param Data The #DataHandle the filter will be applied to
	/// \param Rank The size of the filter 
